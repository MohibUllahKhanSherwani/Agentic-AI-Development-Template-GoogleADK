from VendorRegistrationAndOnboarding.configurations.configure import RootConfigs
from VendorRegistrationAndOnboarding.utils.utilities import load_yaml
...
class ConfigurationManager:
    ...
    def __init__(self):
        ...
        self.config_file_path = base_dir / "Config" / "Config.yaml"
